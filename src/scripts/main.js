...
// document.querySelector('.description__right')
...
// document.querySelector('.description__left')
// .addEventListener('click', () => {
//   if (i > 0) {
//     divs[i].classList.remove('visible');
//     divs[i].classList.add('hidden');
...
// const technologyColorsRight = document
// .getElementById('technology_btn_right');
...
// document
// .querySelector('.technology__right').addEventListener('click', () => {
//   if (count < 1) {
//     count++;
//   }
