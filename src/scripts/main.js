...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function changeLanguage(lang) {
    ...
    const enButtons = document.querySelectorAll('.menu__lang-en, .actions__buttons-en, .actions-desk__buttons-en');
    const uaButtons = document.querySelectorAll('.menu__lang-ua, .actions__buttons-ua, .actions-desk__buttons-ua');
  ...
  enButtons.forEach((btn) => btn.addEventListener('click', () => changeLanguage('en')));
  uaButtons.forEach((btn) => btn.addEventListener('click', () => changeLanguage('ua')));
